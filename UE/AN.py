...
def InitialReq():
	...
	if ret == r1.content :
		...
		print(CurrentPath+":37   "+"[UE][INFO]   "+"post http://127.0.0.1:5001/namf-comm/v1/amfeNBInterface")
		...
		if ret == r2.content :
			...
			print(CurrentPath+":46   "+"[UE][INFO]   "+"post http://127.0.0.1:5001/namf-comm/v1/amfeNBInterface")
			UEReqRigster = "http://127.0.0.1:5001/namf-comm/v1/amfeNBInterface"
			UEInfo = {"imsi":sys.argv[2],"msisdn":"32435235366","key":"8baf473f2f8fd09487cccbd7097c6862","opc":"e734f8734007d6c5ce7a0508809e7e9c","MsgType":"UEReqRigstr","ueListenPort":sys.argv[3]}
			...
			if ret == r3.content :
				...
				print(CurrentPath+":55   "+"[UE][INFO]   "+"post http://127.0.0.1:5001/namf-comm/v1/amfeNBInterface")
				...
				if r4.status_code == 200:
					...
					print(CurrentPath+":63   "+"[UE][INFO]   "+"post http://127.0.0.1:5001/namf-comm/v1/amfeNBInterface")
...
print(sys.argv[1])
create_app().run(port=int(sys.argv[3]))
