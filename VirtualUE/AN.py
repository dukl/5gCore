...
def InitialReq():
	...
	if ret == r1.content :
		...
		if ret == r2.content :
			...
			UEInfo = {"imsi":sys.argv[2],"msisdn":"32435235366","key":"8baf473f2f8fd09487cccbd7097c6862","opc":"e734f8734007d6c5ce7a0508809e7e9c","MsgType":"UEReqRigstr","ueListenPort":enp0s3Ip+":"+sys.argv[3]}
			...
			if ret == r3.content :
				...
				if r4.status_code == 200:
					...
					NASMsg = {"imsi":sys.argv[2],"PDUSessionID":"10","RequestType":"InitialRequest","PDUType":"IPv4v6","MsgType":"PDUSessionEstabilishReq","CreateDataConnection":"TRUE"}
